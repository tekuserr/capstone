...
public class CommonUtility extends BaseSetupp {
    ...
    public String getElementText(WebElement element) {
        return this.waitTillClickable(element).getText();
    }
    ...
    public void sendValueUsingJS(WebElement ele, String value) {
        ...
        executor.executeAsyncScript("arguments[0].value='" + value + "';", ele);
    }
    ...
    public WebElement fluientWaitforElement(WebElement element, int timeoutSec, int pollingSec) {
    ...
    public void selectCalenderDateWithJS(String date, WebElement element) {
        JavascriptExecutor js = ((JavascriptExecutor) getDriver());
